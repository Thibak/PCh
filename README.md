...
* [**docs/architecture\_diagrams.md**](./docs/architecture_diagrams.md): **"ВИЗУАЛИЗАЦИЯ"** — Диаграммы Mermaid (компонентная, последовательности) для `ARCH_CONTRACT.MD`.  
...
* [**docs/modules/diagnostics\_logging.md**](./docs/modules/diagnostics_logging.md): (Централизованный логгер `LOG_INFO(...)`).  
...
* [**docs/modules/hal\_led.md**](./docs/modules/hal_led.md): (Управление LED-индикатором, включая `BLINK_ONCE`).  
...
* [**docs/modules/app\_logic.md**](./docs/modules/app_logic.md): ("Мозг" устройства. Детектор маски, Mute, жесты).  
* [**docs/modules/app\_midi.md**](./docs/modules/app_midi.md): (Формирователь MIDI-сообщений: NoteOn, PitchBend, AllNotesOff).
